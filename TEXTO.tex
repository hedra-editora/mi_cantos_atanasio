...
\hyphenation{pata-mares}
\hyphenation{rapi-da-mente}
...
\letra{P}{erereca}\footnote{Os Kaiowá têm sua própria forma de classificação dos
  ...
  comum na região do \emph{Ka'aguyrusu}; \emph{ytu}, um sapo muito pequeno que
...
Canta o Jaó\footnote{\textls[-8]{A partícula \emph{ju} no termo \emph{Inambuju} se refere
...
alertá-los do perigo, por isso seu \emph{guahu} é assim:\looseness=-1
...
\letra{K}{oa} \textls[-14]{ñemombe'u pyre ojehu va'ekue Jari rehe, Ñanderu kuéra oiko joty
...
comunidades. E os nossos \emph{johechakáry}\footnote{\textls[-3]{\emph{Johechakáry}
  ...
  segundo Atanásio Teixeira, implica a retirada de quatro peles
...
\letra{O}{} \textls[-2]{pássaro Tuiuiú conta sobre seu jeito de viver e se anuncia para os
...
Tujuju omoñesyrũ oguahu ijehegua meme omombe'u.\looseness=-1
...
depois que levou o fogo da Onça.\looseness=-1
