...
\thispagestyle{empty}
\vspace*{\fill}
\emph{\textls[10]{No princípio, chamado pelos Kaiowá e Guarani de \emph{Áraypy}, todas as
...
\letra{A}{} \textls[10]{Jararaca é considerada uma criatura monstruosa, por isso essa cobra
...
\textls[-10]{É verdade que a Jararaca possui vários ovos no seu interior; isso é
...
Jararaca é assim:}\looseness=-1

\begin{verse}
\itshape
Dono da Jararaca\\
Raiz comprida da árvore,\footnote{``Raiz comprida da árvore'' ou \emph{Yvyra pykue puku} é uma metáfora que a cobra Jararaca utiliza para comparar a extensão do seu corpo com a da raiz das árvores.} lá ela bota seus ovos\\
Dono da Jararaca\\
...
\textls[7]{Añetéma, Mbói Jarara oguereko ogupi'a ipuku jave voi oñesyrũ rete rehe;
...
\letra{P}{erereca}\footnote{Os Kaiowá têm sua própria forma de classificação dos
  ...
  nos territórios kaiowá. Já \emph{ju'i mbui}, que é chamada no
  ...
  \emph{ju'ῖ gueῖ} e que se diferencia por meio de seu canto.} \textls[-18]{de cor
  verde, chamada pelos Kaiowá de \emph{ju'i guéĩ}, no princípio da vida,
  ...
  sobre seu jeito de ser, assim:}\looseness=-1
...
\textls[7]{No momento em que a Perereca canta, onde ela está? Difícil perceber ---
...
\textls[-20]{Upéicha ojehe ju'i he'i. Ju'i niko jasareko ramo hese oñe'ẽ haguã ojupi
...
ju'i guahu oheja iñe'ẽngaryháicha.}\looseness=-1
...
caminhar pela mata, Cutia faz os gestos do \emph{jehovasa},\footnote{\emph{Jehovasa}
  se refere a um conjunto de gestos feitos com as mãos, por meio dos quais
  ...
  qualquer mal.} \textls[-5]{desviando todos os males de seu caminho. Só depois de
  ...
  o galho com espinhos de uma planta chamada \emph{ñandy ta’y}. Com ele,
  ...
  mundéu, depois de golpeado com o \emph{ñandy ta’y}, deixa de fazer ruído,
  e Cutia não percebe que é armadilha: só assim é que se captura a Cutia. Caso ainda continue a escapar do mundéu, é preciso pegar um punhado da terra por onde Cutia passou e jogá-lo debaixo do mundéu. Só depois de fazer isso é que Cutia entrará na armadilha. Por isso, Cutia, com seu canto \emph{guahu}, fala de sua esperteza,
  debochando da aparência do mundéu. Ela canta assim:}\looseness=-1
...
\begin{verse}
\itshape
Traga-me meu \emph{tembetá}, minha mãe\\
Traga-me meu \emph{tembetá}, minha mãe\\
Traga-me meu \emph{tembetá}, minha mãe\\
Traga-me meu \emph{tembetá}, minha mãe
...
Ajoelhada no tronco do Juqueri\footnote{Neste verso a Tartaruga fala da Onça, a mulher que insiste no homem que a abandonou. O Juqueri é uma árvore de tronco espinhoso,
...
\letra{K}{arumbe} \textls[5]{ha jaguarete omenda ramo guare rehegua ñemombe'u. Ary ha yvy
...
\textls[10]{Upéicha ha'ekuéry ojotopa jevy y rembe'ýpy, Karumbe katu oguembirekógui 
...
\letra{C}{apivara}, \textls[-7]{conforme a narrativa kaiowá, possui sua história, e ela mesma
...
algo que é visível nas beiras de rios ou lagos por onde anda. Capivara
...
mas, quando percebe o perigo ou é atacada pelo caçador, corre e cai na
...
suja, pois Capivara a todo o momento cai n'água ou, às vezes, deixa a
...
\letra{K}{apiyva} \textls[-10]{ypy oipapa ijehegua omombe'u yrykóta rehe guare. Kapiyva oipapa
...
\letra{P}{or} \textls[-10]{meio de seu canto \emph{guahu}, Lontra conta seu comportamento e
...
\letra{P}{omba}, \textls[-10]{por meio de seu canto \emph{guahu}, conta sobre seu modo de vida,
...
\emph{É a Pomba}, dizem os pássaros\\
\emph{É a Pomba}, dizem os pássaros
\end{verse}
...
\letra{P}{ykasu} \textls[10]{oipapa iguahu rupi iguapy raty rehegua, yvyra rakã hyveraha upéa
...
% \letra{T}{amanduá-bandeira},\footnote{O tamanduá-bandeira ou \emph{kaguaré}, também é chamado pelos Kaiowá de \emph{jarutare} em algumas regiões. Já o tamanduá-mirim é
%   chamado por eles de \emph{kaguaré-mirim}.} no início da sua existência, passou por várias
% situações complicadas. Esses fatos que aconteceram na sua vida são o que
% o tamanduá conta em seu canto \emph{guahu}. Tamanduá-bandeira fala de suas andanças de um lugar para outro à procura de cupins. 
\letra{T}{amanduá-bandeira},\footnote{\textls[-25]{O tamanduá-bandeira ou \emph{kaguaré}, também é chamado pelos Kaiowá de \emph{jarutare} em algumas regiões. Já o tamanduá-mirim é
  chamado por eles de \emph{kaguaré-mirim}.}\looseness=-1} no início de sua existência, viveu situações que conta em seu canto \emph{guahu}. Ele fala de suas andanças de um lugar para outro à procura de cupins para comer. Tamanduá não tem dentes. A sua arma de defesa é sua unha comprida, que usa para
...
\begin{verse}
\itshape
Passeando\footnote{O termo \emph{oñuasa}, encontrado nos cantos e no vocabulário dos mais velhos, é usado para indicar a circulação do tamanduá pelo campo (\emph{ñu}). Aqui optamos por traduzir como um passeio do tamanduá.} pelo campo belo\\
...
\textls[10]{``Isso é o que quero deixar para os seres da Terra'', diz Tamanduá.}
...
\letra{E}{sse} \textls[7]{pássaro é o que os Kaiowá chamam de \emph{Hohoõ} e também de
\emph{Kokoe}. O \emph{Inambuju} vive na mata, especificamente mata baixa e
...
a cada amanhecer e entardecer no mato. O canto de \emph{Inambuju} não é apenas
...
\itshape
Mandei o Jaó\\
Com seu canto singular\footnote{O termo \emph{kamavarῖ}, ``singular'', indica a voz específica do Jaó.}\\
Mandei o Jaó\\
Com seu canto singular

Canta o Jaó\footnote{\textls[-20]{A partícula \emph{ju} no termo \emph{Inambuju} se refere
  ao \emph{jeguaka}, ``diadema'' do Jaó. Novamente, não se trata de uma
  cor, mas do aspecto resplandecente do Inambu.}\looseness=-1}\\
Canta o Jaó\\
Canta o Jaó\\
Canta o Jaó
...
\letra{I}{nambuju} \textls[-5]{je'e guyra hohõpe, ha ojehenói ave ichupe kokoépy. Guyra Hohõo
...
omoypy ypy ichupe haguéicha oiko. Upéa Hohõo oipapa oguahu rupi he'i:}\looseness=-1
...
\letra{O}{} \textls[10]{pássaro Piu-Piu,\footnote{Trata-se do \emph{Myrmorchilus strigilatus},
  também conhecido como \emph{piu-piu} no Brasil. É uma ave passeriforme,
...
Assim é o \emph{guahu} do Piu-piu que os Kaiowá cantam.

\chapter{Guyra pipiu guahu}

\letra{G}{uyra} \textls[-20]{Pipiu ojehekombo'e araka'e oikoha rupi imba'e poroa'o haguã voi.
...
\letra{O}{} \textls[10]{Gato-Dourado conta sobre quando ele vivia em seu patamar sagrado e
...
O Gato-Dourado\footnote{Aqui optamos por traduzir a partícula \emph{ju} como dourado, como uma forma de expressar o aspecto resplandecente deste gato específico. \emph{Mbarakajaju} é o guardião do \emph{chiru}, bastão utilizado pelos xamãs, \emph{ñanderu}.}\\
O Gato-Dourado
...
\letra{P}{iririju}: \textls[-10]{assim é chamado o Anu-Branco. Seu \emph{habitat} são os campos
...
\emph{guahu} do Anu-Branco é assim:}\looseness=-1

\begin{verse}
\itshape
\emph{Anu-Piririju}\footnote{Os Kaiowá aproximam o Piririju ou Piririgua (\emph{Guira
  ...
  de Anu. Novamente, a partícula \emph{ju} no nome do pássaro faz referência ao
  seu ``diadema'' ou \emph{jeguaka} resplandecente.}\\
Fala o pássaro\\
\emph{Anu-Piririju}\\
Fala o pássaro

No emaranhado de cipó\footnote{O verso faz referência à árvore coberta de cipós em que o
...
\letra{E}{sta} \textls[-15]{história conta um fato que aconteceu com Jari, vovó, no
tempo em que as divindades ainda moravam todas juntas aqui na Terra. Um
dia, Ñamoῖ, vovô, foi caçar no mato e matou um tatu. Depois vovô
...
pela grande verde mata.}\looseness=-1
...
\letra{K}{oa} \textls[-15]{ñemombe'u pyre ojehu va'ekue Jari rehe, Ñanderu kuéra oiko joty
...
Yvyra mbyte ra'e, ereguapy reĩ guyra\\ \EP[2]
...
\letra{B}{ugio} \textls[10]{vive na mata grande e nos galhos altos das árvores. Na véspera da
...
\begin{verse}
\itshape
Ele anda mais e mais rápido\footnote{O termo \emph{ava} nesse verso indica que o bugio se vê como gente, \emph{ava}.}\\
Ele anda mais e mais rápido

Ele avista o perobal\footnote{Os perobais eram grandes concentrações de árvores de peroba, uma mata grande e densa, típica da região sul de Mato Grosso do Sul. Com o avanço das frentes agropastoris ao longo do século \textsc{xx} e a expulsão dos Kaiowá de seus territórios, os perobais foram devastados, e sua madeira foi comercializada.}\\
...
\letra{K}{araja} \textls[15]{oiko eteve ka'aguy rusu rupi voi yvyra rakã rehe, ha'e oky haguã
...
\letra{E}{ma} \textls[-5]{narra por meio do \emph{guahu} um fato que aconteceu com ela no
...
\letra{Ñ}{andu} \textls[-9]{omombe'u oguahu rupi ojehegua oñehenóiha takuru pytãpy, upéa va'e
...
ombotavypa gue'ýi ambuekuérype. Upéagui iguahu he'i:}\looseness=-1
...
\letra{P}{ara} \textls[-7]{nossos antepassados, Beija-Flor se mostra como mensageiro da
...
comunidades. E os nossos \emph{johechakáry}\footnote{\emph{Johechakáry}
  ...
  garantido a esses \emph{ñanderu} ou rezadores, por terem corpo e alma
  puros, tendo ultrapassado o \emph{aguyje}, o estado de maturação
...
Beija-Flor e assim cantou:}\looseness=-1
...
Néctar pleno\\
Corpo\footnote{\emph{Retéra}, que se refere ao corpo da bebida fermentada, conforme o entendimento dos Kaiowá.} do cauim me embebeda\footnote{O verbo \emph{juka} pode ser traduzido como ``matar'', mas no Guarani também pode adquirir o sentido de ``embebedar-se'', como empregado nestes versos do \emph{guahu} do Beija-Flor.}\\
Néctar pleno\\
...
\letra{Ñ}{ande} \textls[7]{ypy kuérype araka'e guyra Mainomby ojekuaa ñanderu kuéry ñe'ẽ puku
...
\textls[10]{Upéa ñemoñe'ẽngue opyta Mainomby guahu ramo ko yvypýpe.}
...
\letra{C}{aburé}\footnote{Caburé é o nome popular de um tipo de coruja do gênero
  ...
  provém das línguas tupi-guarani.} \textls[-20]{é um pássaro diferente. Por onde ele
  ...
  ou no início da noite, assim: \emph{hóĩ, hóĩ, hóĩ, hóĩ, hóĩ}\ldots{} Assim canta
  Caburé. O \emph{guahu} de Caburé narra o seu passado e por onde ele
  vive, e como canta em cada entardecer:}\looseness=-1
...
\letra{G}{uyra} \textls[7]{kavure ju oikoha rupi ambue guyra'i ha guyra reko poroangu
...
árvores. Assim Gambá conta a sua vida primordial por meio do
...
\letra{M}{ykurẽ} \textls[-15]{oipapa ogueko ha omohembypy ave iguahu rupi. Mykurẽ omboypy ypy
...
atento às coisas, analisando. Um dia, Veado saiu e caminhou longe do seu
...
\letra{G}{uasu} \textls[7]{ypy oiko reta araka'e ambue mymba ka'aguy ndive, opamba'e rehe
...
\letra{O}{} \textls[-7]{pássaro Tuiuiú conta sobre seu jeito de viver e se anuncia para os
...
sobre o seu jeito de ser.}\looseness=-1
...
alegrando-se grandemente. Neste momento, Saracura falou no meio dos
...
\letra{A}{} \textls[10]{Arara-Vermelha é ajudante indispensável para Ñanderu Vusu. Pássaro
...
rupi oipapa ojeguaka ha reko marane'ỹ rehegua.\looseness=-1
...
Canindé, por meio de seu \emph{guahu}, diz:\looseness=-1
...
\letra{G}{uyra} \textls[-17]{Sapeny oipapa reko oveve oñembiara ara oiko va'ekue araguy rehe
...
que seu fogo não estava mais no lugar. \textls[-5]{Nessa situação, Onça perguntou
