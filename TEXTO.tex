\hyphenation{Tuiuiú}
\hyphenation{ojeroe-ta}
\part{Cantos dos animais primordiais}%\break Guyra guahu ha mymba ka'aguy ayvu}

\chapter*{}
\thispagestyle{empty}
\vspace*{\fill}
\emph{\textls[5]{No princípio, chamado pelos Kaiowá e Guarani de \emph{Áraypy}, todas as
...
\letra{C}{apivara}, conforme a narrativa kaiowá, possui sua história, e ela mesma
...
\letra{T}{amanduá-bandeira},\footnote{O tamanduá-bandeira ou \emph{kaguaré}, também é chamado pelos Kaiowá de \emph{jarutare} em algumas regiões. Já o tamanduá-mirim é
  chamado por eles de \emph{kaguaré-mirim}.} no início de sua existência, viveu situações que conta em seu canto \emph{guahu}. Ele fala de suas andanças de um lugar para outro à procura de cupins para comer. Tamanduá não tem dentes. A sua arma de defesa é sua unha comprida, que usa para
...
motivo, o \emph{guahu} do Tamanduá-Bandeira é assim:\looseness=-1
...
``Isso é o que quero deixar para os seres da Terra'', diz \mbox{Tamanduá}.
...
\letra{E}{sse} pássaro é o que os Kaiowá chamam de \emph{Hohoõ} e também de
...
\letra{O}{}pássaro Piu-Piu,\footnote{Trata-se do \emph{Myrmorchilus strigilatus},
...
\letra{E}{sta} história conta um fato que aconteceu com Jari, vovó, no
