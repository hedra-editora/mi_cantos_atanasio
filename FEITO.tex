...
Spensy Pimentel, coorganizador, foram os responsáveis pelo segmento
...
Universidade de São Paulo (\textsc{ce}st\textsc{a}--\textsc{usp}). Spensy, também pesquisador do \textsc{ce}st\textsc{a}--\textsc{usp}, é hoje professor da Universidade Federal do Sul da Bahia (\textsc{ufsb}).
...
mata, acompanhadas pelos cantos \textit{guahu} que cantam sua história
