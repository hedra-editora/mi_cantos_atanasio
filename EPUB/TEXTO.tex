...
\title{Cantos dos animais primordiais}%\break Guyra guahu ha mymba ka'aguy ayvu}
\author{Ava Ñomoandyja Atanásio Teixeira}
\chapter{}

\textbf{edição brasileira©}       {Hedra 2022}\\
\textbf{organização e tradução©}    {Izaque João}\\
\textbf{coorganização}        {Spensy Pimentel e Tatiane Klein}\\
...
\textbf{revisão do guarani}       {Arnulfo Morínigo Caballero}\\
\textbf{revisão do português}       {Spensy Pimentel, Tatiane Klein e Luísa Valentini}\\
\textbf{capa}               {Lucas Kroëff}\\

\textbf{\textsc{isbn}}          {978-65-89705-30-7}
...
\begin{verse}
Dono da Jararaca\\
Raiz comprida da árvore,\footnote{``Raiz comprida da árvore'' ou \textit{Yvyra pykue puku} é uma metáfora que a cobra Jararaca utiliza para comparar a extensão do seu corpo com a da raiz das árvores.} lá ela bota seus ovos\\
Dono da Jararaca\\
...
\begin{verse}
Passeando\footnote{O termo \textit{oñuasa}, encontrado nos cantos e no vocabulário dos mais velhos, é usado para indicar a circulação do tamanduá pelo campo (\textit{ñu}). Aqui optamos por traduzir como um passeio do tamanduá.} pelo campo belo\\
...
\begin{verse}
Mandei o Jaó\\
Com seu canto singular\footnote{O termo \textit{kamavarῖ}, ``singular'', indica a voz específica do Jaó.}\\
Mandei o Jaó\\
Com seu canto singular

Canta o Jaó\footnote{A partícula \textit{ju} no termo \textit{Inambuju} se refere
...
O gato dourado\footnote{Aqui optamos por traduzir a partícula \textit{ju} como dourado, como uma forma de expressar o aspecto resplandecente deste gato específico. \textit{Mbarakajaju} é o guardião do \textit{chiru}, bastão utilizado pelos xamãs, \textit{ñanderu}.}\\
O gato dourado
...
\begin{verse}
\textit{Anu piririju}\footnote{Os Kaiowá aproximam o Piririju ou Piririgua (\textit{Guira
...
\begin{verse}
Ele anda mais e mais rápido\footnote{O termo \textit{ava} nesse verso indica que o bugio se vê como gente, \textit{ava}.}\\
...
Néctar pleno\\
Corpo\footnote{\textit{Retéra}, que se refere ao corpo da bebida fermentada, conforme o entendimento dos Kaiowá.} do cauim me embebeda\footnote{O verbo \textit{juka} pode ser traduzido como ``matar'', mas no Guarani também pode adquirir o sentido de ``embebedar-se'', como empregado nestes versos do \textit{guahu} do Beija-flor.}\\
Néctar pleno\\
